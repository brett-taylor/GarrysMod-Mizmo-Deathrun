...
function GM:CreateTeams()
	team.SetUp(TEAM_GHOST, "Ghosts", Colours.Team.Ghost, false)
	team.SetUp(TEAM_RUNNER, "Runners", Colours.Team.Runner, false)
	team.SetUp(TEAM_DEATH, "Deaths", Colours.Team.Death, false)
