...
function PANEL:Init()
	...
	self.LabelName:SetTextColor( Colours.Gold )

	self.AvBox = vgui.Create("DFrame", self)
	self.AvBox:SetSize(36, 36)
	self.AvBox:SetPos(2, 2)
	self.AvBox:SetTitle("")
	self.AvBox:SetDraggable(false)
	self.AvBox:ShowCloseButton(false)
