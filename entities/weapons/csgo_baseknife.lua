...
if ( SERVER ) then
  ...
  CreateConVar("csgo_knives_dmg_sec_back", 25, FCVAR_ARCHIVE, "How much damage deal when hit with secondary attack from behind")
  CreateConVar("csgo_knives_dmg_sec_front", 25, FCVAR_ARCHIVE, "How much damage deal when hit with secondary attack in front or from side")
  CreateConVar("csgo_knives_dmg_prim_back", 25, FCVAR_ARCHIVE, "How much damage deal when hit with primary attack from behind")
  CreateConVar("csgo_knives_dmg_prim_front1", 25, FCVAR_ARCHIVE, "How much damage deal when firstly hit with primary attack in front or from side")
